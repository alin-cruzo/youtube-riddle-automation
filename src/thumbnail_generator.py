...
class ThumbnailGenerator:
    ...
    def create_thumbnail(self, riddle_data, output_path):
        ...
        # Load font
        try:
            font_large = ImageFont.truetype(str(self.assets_dir / "fonts" / "bold_font.ttf"), 120)
            font_medium = ImageFont.truetype(str(self.assets_dir / "fonts" / "bold_font.ttf"), 80)
            font_small = ImageFont.truetype(str(self.assets_dir / "fonts" / "bold_font.ttf"), 60)
        except:
